...
//Cases to implement the PID controller 
#define PID_without_Twiddle
//#define Twiddle_Module 
...
Then, starting from this character, takes as many characters as possible that are valid following a syntax resembling that of floating point literals
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
           ...
           */
          #ifdef PID_without_Twiddle
          pid.UpdateError(cte);
          steer_value = pid.TotalError();
          #endif
          
          #ifdef Twiddle_Module         
          pid.UpdateError(cte);          
